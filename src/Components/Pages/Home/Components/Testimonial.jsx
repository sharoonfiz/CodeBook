...
const Testimonial = () => {
    return (
        <section className=' my-20  ' >
            ...
            <h1 className="text-2xl  text-center font-semibold dark:text-slate-100 mb-16 underline underline-offset-8">Student About CodeBook</h1>

            <div className="grid mb-8 rounded-lg border border-gray-200 shadow-sm dark:border-cyan-500 md:mb-12 md:grid-cols-2">
