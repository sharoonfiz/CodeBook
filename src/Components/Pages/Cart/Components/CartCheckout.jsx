...
import { userOrders } from '../../../../Services/Dataservice';
import UseTitle from '../../../../Hooks/UseTitle';

const CartCheckout = ({ setCheckout, SubTotal }) => {
    UseTitle("Cart Checkout payment ")
    ...
    const handleOrderSubmit = async (e) => {
        ...
        try {
            ...
            const data = await userOrders(cartItems, SubTotal, user)

            dispatch({ type: "CLEAR_CART", payload: "" })

            navigate('/orderPage', { state: { orderData: data, status: true } })

        } catch (error) {
            navigate('/orderPage', { state: { orderData: data, status: false } })
        }
